...
API_ID = int(environ.get('API_ID', '7236453'))
API_HASH = environ.get('API_HASH', '33010a70e94f80e55145980072cce969')
BOT_TOKEN = environ.get('BOT_TOKEN', '7229655009:AAF4ARyxrXOcdWMleSok_gTRUTmT_N3qbD8')
...
# Bot images & videos
PICS = (environ.get('PICS', 'https://envs.sh/CeN.jpg https://envs.sh/CeH.jpg https://envs.sh/Ceg.jpg')).split()
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002312169630').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '6891428437').split()]
